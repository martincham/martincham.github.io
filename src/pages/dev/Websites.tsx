  ...
  return (
    <div className="container mx-auto p-6">
      <section className="container mx-auto py-2">
        <p>
          I built my first simple HTML/CSS portfolio website in 2016. Since
          then, I expanded my web-dev toolkit with JavaScipt and TypeScript in
          2019. Most recently I built this website using a modern tech-stack.
        </p>
